...
const BlogCard = ({item}:Props) => {
    const {date,id,image,summary,title} = item
  return (
    ...
    <div className='p-6'>
        ...
        <h1 className='sm:text-lg text-base cursor-pointer hover:text-gray-100 hover:underline transition-all duration-200 mt-6 mb-4 text-gray-200 leading-[1.6rem] font-bold'>{title}</h1>
        <p className='text-sm font-semibold text-gray-400/70'>{summary}</p>
        <div className='mt-4 mb-4 w-full h-[1.5px] bg-gray-400/45'></div>
