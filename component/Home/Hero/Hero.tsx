      ...
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div>
            ...
            <p
              ref={descriptionRef}
              className="mt-6 text-sm md:text-base text-white/60 text-justify"
            >
            ...
            <div ref={socialIconsRef} className="flex items-center gap-4 pt-3">
              <a
                ...
                href="https://www.linkedin.com/in/aryan-shetty-1972012b0"
                target="_blank"
              >
                <FaLinkedin className="text-white w-7 h-7 hover:scale-125 transition-all duration-300" />
              </a>
              <a
                ref={(el) => {
                ...
                href={
                  "https://www.instagram.com/shettyaryan01?igsh=MTE2bXZobTQ5ajZucA=="
                }
                target="_blank"
              >
                <FaInstagram className="text-white w-7 h-7 hover:scale-125 transition-all duration-300" />
              </a>
              <a
                ref={(el) => {
                ...
                target="_blank"
              >
                <FaGithub className="text-white w-7 h-7 hover:scale-125 transition-all duration-300" />
              </a>
              <a
                ref={(el) => {
                  iconRefs.current[3] = el;
                }}
                href={"https://x.com/AryanDevelops01"}
                target="_blank"
              >
                <FaTwitter className="text-white w-7 h-7 hover:scale-125 transition-all duration-300" />
              </a>
            </div>
            <a
