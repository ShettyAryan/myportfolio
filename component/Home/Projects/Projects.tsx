      ...
      <div className="w-[80%] mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 items-stretch">
        {projectData.map((project) => (
          <div
            ...
            className="bg-blue-950 p-6 rounded-lg hover:scale-105 transition-all duration-300 h-full"
          >
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {project.techStack.map((tech, i) => (
                <span
                  className="bg-blue-800 text-xs px-4 py-2 rounded-full text-white hover:bg-blue-700"
                  key={i}
                >
                  {tech}
                </span>
